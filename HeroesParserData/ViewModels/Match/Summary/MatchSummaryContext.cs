...
namespace HeroesParserData.ViewModels.Match.Summary
{
    public abstract class MatchSummaryContext : MatchContextBase
    {
        ...
        public MatchSummaryGraphs MatchSummaryGraphs { get; private set; } = new MatchSummaryGraphs();
        ...
        protected void QuerySummaryDetails()
        {
            ...
            try
            {
                ...
                var matchTeamExperienceList = replay.ReplayMatchTeamExperiences.ToList();
                ...
                {
                    MatchSummaryGraphs.GraphTeam0Title = "Team 1 (Winner)";
                    MatchSummaryGraphs.GraphTeam1Title = "Team 2";
                }
                else
                {
                    MatchSummaryGraphs.GraphTeam0Title = "Team 1";
                    MatchSummaryGraphs.GraphTeam1Title = "Team 2 (Winner)";
                }
                ...
                //// graphs
                MatchSummaryGraphs.SetTeamLevelSeriesCollection(matchTeamLevelsList);
                MatchSummaryGraphs.SetTeamExperienceSeriesCollection(matchTeamExperienceList);
            }
            catch (Exception ex)
            {
